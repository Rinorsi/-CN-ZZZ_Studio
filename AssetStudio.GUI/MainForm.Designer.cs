...
displayAll.ToolTipText = "勾选此选项将显示所有类型的资源。无法提取的资源可以导出为原始文件。";
...
enablePreview.ToolTipText = "切换加载和预览可读资源，如图片、声音、文本等。\r\n如果遇到性能或兼容性问题，请禁用预览。";
...
displayInfo.ToolTipText = "切换显示每个资源的信息叠加层，如图像大小、格式、音频比特率等。";
...
allowDuplicates.Text = "允许重复项";
allowDuplicates.ToolTipText = "切换导出资源的行为。\r\n启用以允许导出重复名称的资源。";
...
specifyUnityCNKey.Text = "指定 UnityCN 密钥";
...
toolStripMenuItem19.Text = "指定 AI 版本";
...
exportAllObjectssplitToolStripMenuItem1.Text = "导出所有对象（分割）";
...
exportSelectedObjectsToolStripMenuItem.Text = "导出选定对象（分割）";
...
exportSelectedObjectsWithAnimationClipToolStripMenuItem.Text = "导出选定对象（分割）+ 选定的动画片段";
...
exportSelectedObjectsmergeToolStripMenuItem.Text = "导出选定对象（合并）";
...
exportSelectedObjectsmergeWithAnimationClipToolStripMenuItem.Text = "导出选定对象（合并）+ 选定的动画片段";
...
exportSelectedNodessplitToolStripMenuItem.Text = "导出选定节点（分割）";
...
exportSelectedNodessplitSelectedAnimationClipsToolStripMenuItem.Text = "导出选定节点（分割）+ 选定的动画片段";
...
exportAnimatorWithSelectedAnimationClipToolStripMenuItem.Text = "导出动画师+选定的动画片段";
...
toolStripMenuItem10.Text = "Asset列表到XML";
// 
// toolStripMenuItem11
// 
...
MapNameComboBox.ToolTipText = "在此处输入Map名称";
// 
...
buildMapToolStripMenuItem.Text = "构建Map";
...
buildBothToolStripMenuItem.Text = "构建全部";
...
clearMapToolStripMenuItem.Text = "清除Map";
...
assetMapNameTextBox.ToolTipText = "在此输入AsseMap名称";
// 
...
buildAssetMapToolStripMenuItem.Text = "生成AssetMap";
...
treeSearch.PlaceholderText = "搜索 (按Ctrl键检查结果, 按Shift键检查所有, 按Alt键检查父节点)";
...
FMODcopyright.Text = "音频引擎由Firelight Technologies提供的FMOD提供支持。";
// 
// FMODinfoLabel
// 
...
Text = "AssetStudio.GUI(汉化by.Rinorsi)";
